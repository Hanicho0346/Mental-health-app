...
type Step = 1 | 2 | 3; // 1=role, 2=form, 3=otp
      ...
      <SafeAreaView style={s.container}>
        ...
        <ScrollView style={s.scroll}>
          <View style={s.roleContainer}>
            ...
            <TouchableOpacity style={s.roleCard} onPress={() => { setRole('user'); setStep(2); }}>
              ...
              <View style={s.roleTextContainer}>
                ...
                <Text style={s.roleDescription}>Find support and track your mental wellbeing.</Text>
              </View>
              <Feather name="chevron-right" size={24} color="#9CA3AF" />
            </TouchableOpacity>

            <TouchableOpacity style={s.roleCard} onPress={() => { setRole('psychiatrist'); setStep(2); }}>
              <View style={s.roleIconCircle}>
                <Feather name="briefcase" size={28} color="#4ADE80" />
              </View>
              <View style={s.roleTextContainer}>
                <Text style={s.roleTitle}>Sign Up as Psychiatrist</Text>
                <Text style={s.roleDescription}>Offer professional help and manage patients.</Text>
              </View>
              <Feather name="chevron-right" size={24} color="#9CA3AF" />
            </TouchableOpacity>
          </View>
    ...
    return (
      <SafeAreaView style={s.container}>
        ...
        <ScrollView style={s.scroll}>
          ...
          >
            <Text style={{ color: '#4ADE80', fontSize: 14, fontWeight: '600' }}>Resend code</Text>
          </TouchableOpacity>
        ...
        <View style={s.formCard}>
          <View style={s.inputGroup}>
            ...
            <View style={s.inputContainer}>
              <TextInput style={s.input} placeholder="Hana Alemu" placeholderTextColor="#9CA3AF" value={fullName} onChangeText={setFullName} />
            </View>
          </View>
          ...
          <View style={s.inputGroup}>
            ...
            <View style={s.inputContainer}>
              <TextInput style={s.input} placeholder="hana@example.com" keyboardType="email-address" autoCapitalize="none" placeholderTextColor="#9CA3AF" value={email} onChangeText={setEmail} />
            </View>
          </View>
          ...
          <View style={s.inputGroup}>
            ...
            <View style={s.inputContainer}>
              <TextInput style={s.input} placeholder="••••••••" secureTextEntry={!showPassword} placeholderTextColor="#9CA3AF" value={password} onChangeText={setPassword} />
          ...
          {role === 'psychiatrist' && (
            <>
              ...
              <View style={s.inputGroup}>
                ...
                <View style={s.inputContainer}>
                  <TextInput style={s.input} placeholder="ID-12345678" placeholderTextColor="#9CA3AF" value={nationalId} onChangeText={setNationalId} />
                </View>
              </View>
              ...
              <View style={s.inputGroup}>
                ...
                <View style={s.inputContainer}>
                  <TextInput style={s.input} placeholder="MED-98765432" placeholderTextColor="#9CA3AF" value={licenseNumber} onChangeText={setLicenseNumber} />
                </View>
              </View>
              ...
              <View style={s.inputGroup}>
                ...
                <View style={s.inputContainer}>
                  <TextInput style={s.input} placeholder="Clinical Psychology, CBT..." placeholderTextColor="#9CA3AF" value={specialization} onChangeText={setSpecialization} />
                </View>
              </View>
              ...
              <View style={s.inputGroup}>
                ...
                <View style={s.inputContainer}>
                  <TextInput style={s.input} placeholder="5" keyboardType="numeric" placeholderTextColor="#9CA3AF" value={experience} onChangeText={setExperience} />
                </View>
              </View>

              <TouchableOpacity style={s.uploadBox} onPress={() => setCertificateUploaded(!certificateUploaded)}>
                <Feather name="upload-cloud" size={28} color={certificateUploaded ? '#4ADE80' : '#9CA3AF'} />
                <Text style={[s.uploadText, certificateUploaded && { color: '#4ADE80' }]}>
                  {certificateUploaded ? 'Certificate Uploaded Successfully' : 'Tap to upload medical certificate (PDF/JPG)'}
                </Text>
              </TouchableOpacity>
            </>
          )}
          ...
          <View style={s.infoBox}>
            ...
            <Text style={[s.infoText, { marginLeft: 10 }]}>Your data is private and securely encrypted.</Text>
          </View>
        </View>

        <TouchableOpacity style={s.continueButton} onPress={() => void handleRegister()} disabled={submitting}>
          {submitting ? <ActivityIndicator color="#111827" /> : <Text style={s.continueButtonText}>Create Account</Text>}
        </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  roleCard: { width: '100%', backgroundColor: '#FFFFFF', padding: 20, borderRadius: 16, flexDirection: 'row', alignItems: 'center', marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 2, borderWidth: 1, borderColor: '#F3F4F6' },
  roleIconCircle: { width: 56, height: 56, borderRadius: 28, backgroundColor: '#DCFCE7', justifyContent: 'center', alignItems: 'center', marginRight: 16 },
  ...
  inputContainer: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 12, paddingHorizontal: 16, height: 50, backgroundColor: '#F9FAFB' },
  input: { flex: 1, fontSize: 15, color: '#111827' },
  uploadBox: { borderWidth: 1.5, borderColor: '#E5E7EB', borderStyle: 'dashed', borderRadius: 12, padding: 20, alignItems: 'center', backgroundColor: '#F9FAFB', marginBottom: 16 },
  uploadText: { fontSize: 13, color: '#6B7280', marginTop: 10, textAlign: 'center' },
  infoBox: { flexDirection: 'row', backgroundColor: '#FFFBEB', padding: 16, borderRadius: 12, marginTop: 10 },
  infoText: { fontSize: 12, color: '#4B5563', lineHeight: 18, flex: 1 },
  continueButton: { backgroundColor: '#4ADE80', borderRadius: 16, height: 56, justifyContent: 'center', alignItems: 'center', marginTop: 24 },
